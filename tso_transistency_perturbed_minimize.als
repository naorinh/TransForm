...
fact { #(Event - ExtraInstructions.remove - ExtraInstructions.remove.rmw - ExtraInstructions.remove.~rmw - ExtraInstructions.remove.ghost - ExtraInstructions.remove.remap) < 10 }
