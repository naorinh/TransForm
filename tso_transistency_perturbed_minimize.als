...
fact { all e: Event | e in ExtraInstructions.remove => (not e in ghost and not e in Write.remap) }

fact not_all_inst_removed { not {Event - ghost - Write.remap} in ExtraInstructions.remove }

let interesting_not_axiom[axiom] {
  not axiom[RE->(ExtraInstructions.remove + ExtraInstructions.remove.rmw + ExtraInstructions.remove.~rmw + ExtraInstructions.remove.go + ExtraInstructions.remove.remap +
                ExtraInstructions.remove.rf_pa + ExtraInstructions.remove.rf_pa.rmw + ExtraInstructions.remove.rf_pa.~rmw + ExtraInstructions.remove.rf_pa.go)]

  // All events must be relevant and minimal
  all e: Event - ghost - Write.remap - ExtraInstructions.remove | transistency_model[RE->(ExtraInstructions.remove + ExtraInstructions.remove.rmw + ExtraInstructions.remove.~rmw + ExtraInstructions.remove.go + ExtraInstructions.remove.remap +
                                                                ExtraInstructions.remove.rf_pa + ExtraInstructions.remove.rf_pa.rmw + ExtraInstructions.remove.rf_pa.~rmw + ExtraInstructions.remove.rf_pa.go +
                                                                e + e.rmw + e.~rmw + e.go + e.remap)]
...
fact { #(Event - ExtraInstructions.remove - ExtraInstructions.remove.rmw - ExtraInstructions.remove.~rmw - ExtraInstructions.remove.go - ExtraInstructions.remove.remap) < 11 }
