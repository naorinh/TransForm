...
pred n2 {
  ...
  (
    ...
    r40->r50 in ^po and
    r60->r70 in ^po and
    !SameThread[w00, w20] and
    !SameThread[w00, r40] and
    !SameThread[w00, r60] and
    !SameThread[w20, r40] and
    !SameThread[w20, r60] and
    !SameThread[r40, r60] and
    SamePhysicalAddress[w00, w20] and
    SamePhysicalAddress[w00, r40] and
